...
export class ElectricityChartComponent implements AfterViewInit, OnDestroy {
  ...
  constructor(private theme: NbThemeService) {
    ...
    const points = [400, 490, 450, 500, 505, 510, 590, 530, 550, 580, 630,
      720, 200, 300, 860, 870,400, 860, 840, 800, 720, 200, 145, 130, 130,
      145, 200, 570, 635, 660, 600, 670, 620, 630, 580, 460, 500, 450, 340,
      340, 500, 520, 340, 340, 450, 340, 340];

      
    const months = ['JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN', 'JUL', 'AUG', 'SEP', 'OCT', 'NOV', 'DEC'];
    const map = months.map(x => months[x]);
    // const points = [];
    // let pointsCount = 100;
    // let min = -3;
    // let max = 3;
